...
//		System.out.println("expected:" + (double)23/41 + (double)2/41);
	...
	public void parseTest() {
		...
		ComplexNumber.parse("  223,-334i");
		assertEquals(cnum, ComplexNumber.parse("  223,-i334"));
		
		cnum.setValue(4234, -3123);
		assertEquals(cnum, ComplexNumber.parse("  4234 -i3123"));
		
		cnum.setValue(2213112, 104343);
		assertEquals(cnum, ComplexNumber.parse(" 2213112 i104343"));
		
		cnum.setValue(123212, 343434);
		assertEquals(cnum, ComplexNumber.parse("123212,     i343434"));
		
		cnum.setValue(0,0);
		assertEquals(cnum, ComplexNumber.parse("  0    i0  "));

		//bad
		cnum.setValue(0,-3);
		assertNotEquals(cnum, ComplexNumber.parse("-3"));
		
		cnum.setValue(1,-3);
		assertNotEquals(cnum, ComplexNumber.parse(" 1,asd-i3"));
		
		cnum.setValue(2,0);
		assertNotEquals(cnum, ComplexNumber.parse("  2,,a , i0"));
		
		cnum.setValue(0,3);
		assertNotEquals(cnum, ComplexNumber.parse("0, a, b, c, i3"));
	}
